...
"<div class=warn><b>Проверка моста без всякого железа:</b> открой эту же "
"страницу на второй плате, включи терминал того же порта — и переписывайся. "
"Отправленное здесь появится там с пометкой <b>N</b>, и наоборот.<br><br>"
"Пометки: <b>U</b> — байты пришли с UART, <b>N</b> — из сети от партнёра. "
"Строки со <b>&gt;</b> — отправленные отсюда.<br><br>"
"Порт должен быть в прозрачном режиме: в режиме CRSF плата разбирает "
"входящее как фреймы и обычный текст дальше не пропустит.<br><br>"
